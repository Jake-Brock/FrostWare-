...
UI["15"]['Rotation'] = -50;
UI["15"]['Transparency'] = NumberSequence.new({NumberSequenceKeypoint.new(0, 0.6),NumberSequenceKeypoint.new(1, 0.6)});
UI["15"]['Color'] = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 60, 95)),ColorSequenceKeypoint.new(1, Color3.fromRGB(51, 82, 121))});
...
UI["1a"]['Rotation'] = -50;
UI["1a"]['Transparency'] = NumberSequence.new({NumberSequenceKeypoint.new(0, 0.2),NumberSequenceKeypoint.new(1, 0.2)});
UI["1a"]['Color'] = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 60, 95)),ColorSequenceKeypoint.new(1, Color3.fromRGB(51, 82, 121))});
...
UI["1e"]['Rotation'] = -50;
UI["1e"]['Transparency'] = NumberSequence.new({NumberSequenceKeypoint.new(0, 0.2),NumberSequenceKeypoint.new(1, 0.2)});
UI["1e"]['Color'] = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 60, 95)),ColorSequenceKeypoint.new(1, Color3.fromRGB(51, 82, 121))});
...
UI["24"]['Rotation'] = -50;
UI["24"]['Transparency'] = NumberSequence.new({NumberSequenceKeypoint.new(0, 0.6),NumberSequenceKeypoint.new(1, 0.6)});
UI["24"]['Color'] = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 60, 95)),ColorSequenceKeypoint.new(1, Color3.fromRGB(51, 82, 121))});
...
UI["2a"]['Rotation'] = -50;
UI["2a"]['Transparency'] = NumberSequence.new({NumberSequenceKeypoint.new(0, 0.6),NumberSequenceKeypoint.new(1, 0.6)});
UI["2a"]['Color'] = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 60, 95)),ColorSequenceKeypoint.new(1, Color3.fromRGB(51, 82, 121))});
...
UI["43"]['Rotation'] = -50;
UI["43"]['Transparency'] = NumberSequence.new({NumberSequenceKeypoint.new(0, 0.6),NumberSequenceKeypoint.new(1, 0.6)});
UI["43"]['Color'] = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 60, 95)),ColorSequenceKeypoint.new(1, Color3.fromRGB(51, 82, 121))});
...
local function SCRIPT_5()
	...
	script.Parent:WaitForChild("PasteButton").MouseButton1Click:Connect(function()
		SyntaxEditor.Text = (getclipboard or function()
		end)();
	end);
end
task.spawn(SCRIPT_5);
...
local function SCRIPT_d()
	...
	ListCode = {["local"]="rgb(173, 216, 230)",["function"]="rgb(70, 130, 180)",["end"]="rgb(70, 130, 180)",["if"]="rgb(100, 149, 237)",["then"]="rgb(100, 149, 237)",["else"]="rgb(100, 149, 237)",["elseif"]="rgb(100, 149, 237)",["return"]="rgb(65, 105, 225)",["while"]="rgb(70, 130, 180)",["for"]="rgb(70, 130, 180)",["do"]="rgb(70, 130, 180)",["break"]="rgb(65, 105, 225)",["continue"]="rgb(65, 105, 225)",["and"]="rgb(70, 130, 180)",["or"]="rgb(70, 130, 180)",["not"]="rgb(70, 130, 180)",["repeat"]="rgb(135, 206, 235)",["until"]="rgb(135, 206, 235)",["nil"]="rgb(100, 149, 237)",["true"]="rgb(100, 149, 237)",["false"]="rgb(100, 149, 237)",["in"]="rgb(70, 130, 180)",["goto"]="rgb(100, 149, 237)",["%d+%.?%d*"]="rgb(0, 0, 255)",['"[^"]*"']="rgb(176, 224, 230)",["'[^']*'"]="rgb(176, 224, 230)",["[%+%-%*/%%%^#=<>~]"]="rgb(70, 130, 180)",["[%(%)]"]="rgb(70, 130, 180)",["[%[%]]"]="rgb(70, 130, 180)",["[%{%}]"]="rgb(70, 130, 180)",["%."]="rgb(30, 144, 255)",[":"]="rgb(30, 144, 255)",print="rgb(0, 191, 255)",wait="rgb(0, 191, 255)",loadstring="rgb(0, 0, 139)",assert="rgb(0, 191, 255)",error="rgb(0, 191, 255)",pcall="rgb(0, 191, 255)",xpcall="rgb(0, 191, 255)",tonumber="rgb(0, 191, 255)",tostring="rgb(0, 191, 255)",type="rgb(0, 191, 255)",next="rgb(0, 191, 255)",getmetatable="rgb(0, 191, 255)",setmetatable="rgb(0, 191, 255)",rawget="rgb(0, 191, 255)",rawset="rgb(0, 191, 255)",select="rgb(0, 191, 255)",collectgarbage="rgb(0, 191, 255)",rawequal="rgb(0, 191, 255)",unpack="rgb(0, 191, 255)",dofile="rgb(0, 191, 255)",loadfile="rgb(0, 191, 255)",require="rgb(0, 191, 255)",game="rgb(0, 191, 255)",workspace="rgb(0, 191, 255)",script="rgb(0, 191, 255)",spawn="rgb(255, 165, 0)",delay="rgb(255, 165, 0)",task="rgb(255, 165, 0)",tick="rgb(255, 165, 0)",time="rgb(255, 165, 0)",Players="rgb(255, 140, 0)",Lighting="rgb(255, 140, 0)",ReplicatedStorage="rgb(255, 140, 0)",ServerStorage="rgb(255, 140, 0)",TweenService="rgb(255, 140, 0)",RunService="rgb(255, 140, 0)",UserInputService="rgb(255, 140, 0)",MarketplaceService="rgb(255, 140, 0)",GuiService="rgb(255, 140, 0)",CoreGui="rgb(255, 140, 0)",Stats="rgb(255, 140, 0)",Instance="rgb(148, 0, 211)",BrickColor="rgb(148, 0, 211)",Vector3="rgb(148, 0, 211)",CFrame="rgb(148, 0, 211)",Color3="rgb(148, 0, 211)",UDim2="rgb(148, 0, 211)",Rect="rgb(148, 0, 211)",Ray="rgb(148, 0, 211)",Region3="rgb(148, 0, 211)",Enum="rgb(148, 0, 211)"};
...
local function SCRIPT_2b()
	...
	for _, frame in ipairs(screenGui:GetChildren()) do
		if frame:IsA("Frame") then
			originalProperties[frame] = {Position=frame.Position,Size=frame.Size};
		end
	end
	button.MouseButton1Click:Connect(function()
		if toggle then
			...
			for frame, props in pairs(originalProperties) do
				local tweenInfo = TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out);
				local goal = {Position=props.Position,Size=props.Size};
				local tween = tweenService:Create(frame, tweenInfo, goal);
				tween:Play();
			end
			toggle = true;
...
local function SCRIPT_2c()
	...
	local function Update(dt)
		...
		if (not dragging and lastGoalPos) then
			gui.Position = UDim2.new(initialPos.X.Scale, Lerp(gui.Position.X.Offset, lastGoalPos.X.Offset, dt * DRAG_SPEED), initialPos.Y.Scale, Lerp(gui.Position.Y.Offset, lastGoalPos.Y.Offset, dt * DRAG_SPEED));
			return;
		end
		...
		gui.Position = UDim2.new(initialPos.X.Scale, Lerp(gui.Position.X.Offset, newX, dt * DRAG_SPEED), initialPos.Y.Scale, Lerp(gui.Position.Y.Offset, newY, dt * DRAG_SPEED));
	end
...
local function SCRIPT_30()
	...
	local setclipboard = setclipboard or function(_)
	end;
...
UI['Back'].MouseButton1Click:Connect(function()
	...
	if (totalButtons == 0) then
		...
		for _, button in ipairs(animatingButtons) do
			...
			local btnTween = TweenService:Create(button, tweenInfo, {Size=UDim2.new(0, 0, originalSizes[button].Y.Scale, originalSizes[button].Y.Offset)});
			btnTween:Play();
...
UI['IY_B'] = UI["20"]:Clone();
UI['IY_B'].Parent = UI['NewSectionFrame'];

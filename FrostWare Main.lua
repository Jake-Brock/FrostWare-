...
local function SCRIPT_d()
    ...
    ListCode = {
        ...
        ["BackgroundTransparency"]= "rgb(220,20,60)",
        ["Text"]                = "rgb(220,20,60)",
        ["TextColor3"]          = "rgb(220,20,60)",
        ["TextScaled"]          = "rgb(220,20,60)",
        ["TextSize"]            = "rgb(220,20,60)",
        ["TextWrapped"]         = "rgb(220,20,60)",
        ["Font"]                = "rgb(220,20,60)",
        ["Image"]               = "rgb(220,20,60)",
        ["ImageColor3"]         = "rgb(220,20,60)",
        ["ImageTransparency"]   = "rgb(220,20,60)",
        ["LayoutOrder"]         = "rgb(220,20,60)",
        ["ZIndex"]              = "rgb(220,20,60)",
        ["AnchorPoint"]         = "rgb(220,20,60)",
        ["BorderSizePixel"]     = "rgb(220,20,60)",
        ["BorderColor3"]        = "rgb(220,20,60)",
        ["SizeConstraint"]      = "rgb(220,20,60)",
        ["AspectRatio"]         = "rgb(220,20,60)",
        ["AspectType"]          = "rgb(220,20,60)",
        ["ClipDescendants"]     = "rgb(220,20,60)",
        ["ScrollingEnabled"]    = "rgb(220,20,60)",
        ["CanvasSize"]          = "rgb(220,20,60)",
        ["ScrollBarThickness"]  = "rgb(220,20,60)",
        ["ScrollBarImageColor3"]= "rgb(220,20,60)",
        ["ScrollBarImageTransparency"] = "rgb(220,20,60)"
    }    

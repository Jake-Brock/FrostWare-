...
local Config = {} do
  ...
  Config.service = 803
  Config.secret = "6429e748-e9df-4d59-b09d-a8f0f97eee05"
...
subtext.Text = "Complete this simple key system and enjoy exploiting ;)"
...
checkKeyButton.MouseButton1Click:Connect(function()
    ...
    if Config:Verify_Key(enteredKey) then
